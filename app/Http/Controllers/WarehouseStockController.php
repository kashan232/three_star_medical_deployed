...
class WarehouseStockController extends Controller
{
    ...
    public function index()
    {
        ...
        // Group by product and warehouse to avoid showing the same product multiple times if it has multiple UOMs
        $stocks = WarehouseStock::with(['warehouse.branch', 'product.packings'])
            ->select('product_id', 'warehouse_id', DB::raw('SUM(total_pieces) as total_pieces'))
