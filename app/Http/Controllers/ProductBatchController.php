...
class ProductBatchController extends Controller
{
    ...
    public function openingStockForm()
    {
        ...
        // Use branch scope only when the current user has a branch assigned.
        // Prevents `where('branch_id', null)` from hiding all registered warehouses.
        $warehouses = Warehouse::when($this->getBranchId(), fn($q, $bid) => $q->where('branch_id', $bid))
