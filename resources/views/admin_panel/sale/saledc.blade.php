        ...
        <table class="invoice-table">
            <thead>
                <tr>
                    ...
                    <th class="text-center" style="width: 25%">Packing</th>
                </tr>
            </thead>
            <tbody>
                    ...
                    <tr>
                        <td class="text-start">
                            ...
                            <div style="font-size: 11px; color: #555; line-height: 1.2;">
                                ...
                                <span class="d-inline-block ms-1">
                                    Packing: {{ $piecesPerBox }} units | {{ number_format($m2PerBox, 4) }} m²
                                </span>
                            </div>
                        </td>
                        ...
                        <td class="text-center" style="vertical-align: middle;">
                            <span class="fw-bold">
                                {{ $sizeMode == 'by_size' ? number_format($totalM2Line, 4) . ' m²' : $item['uom_name'] }}
                            </span>
                        </td>
                    </tr>
                @endforeach
