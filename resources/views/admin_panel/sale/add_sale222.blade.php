        ...
        <label class="btn btn-outline-primary btn-sm" for="typeVendors">Vendors</label> --}}
                        ...
                        <div id="customerInfoCard" class="mb-2 p-2 border rounded-2 bg-light d-none">
                            <table class="table table-sm table-borderless mb-0" style="font-size:0.82rem">
                                ...
                                <tr>
                                    <td class="fw-bold text-muted py-0">Credit Status</td>
                                    <td class="py-0" id="ci_status">DO NOT NOTIFY</td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-select" id="salesOfficerSelect" name="sales_officer_id">
                                ...
                                @foreach ($employees as $emp)
                                    <option value="{{ $emp->id }}"
                                        {{ isset($sale) && $sale->employee_id == $emp->id ? 'selected' : '' }}>
                                        {{ $emp->full_name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <input type="hidden" id="creditStatus" value="">
                ...
                <div class="row g-3 mt-3">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="totals-card p-3">
                            ...
                            <div class="row py-1">
                                <div class="col-7 text-info">Total Free Qty</div>
                                <div class="col-5 text-end"><span id="tFreeQty">—</span></div>
                            </div>
                            <div class="row py-1">
        ...
        $(document).ready(function() {
            ...
            $('#customerSelect').on('select2:select', function(e) {
                ...
                $.get("{{ url('sale/customers') }}/" + id + "?t=" + new Date().getTime(), function(d) {
                    ...
                    $('#creditStatus').val(d.credit_status || 'DO NOT NOTIFY');
                    ...
                    $('#ci_status').text(d.credit_status || 'DO NOT NOTIFY');
