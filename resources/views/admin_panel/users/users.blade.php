                        ...
                        @forelse($users as $user)
                            <div class="user-card" data-user-id="{{ $user->id }}"
                                ...
                                <div class="mt-2">
                                    @if ($user->branch)
                                        <span class="badge"
                                            style="background:linear-gradient(135deg,#0d6efd,#06c0d4);color:#fff;font-size:0.75rem;padding:4px 10px;border-radius:12px;">
                                            <i class="fas fa-code-branch me-1"></i> {{ $user->branch->name }}
                                        </span>
                                    @else
                                        <span class="badge bg-secondary"
                                            style="font-size:0.75rem;padding:4px 10px;border-radius:12px;">
                                            <i class="fas fa-ban me-1"></i> No Branch
                                        </span>
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group-modern">
                                    ...
                                    <small class="text-muted">Leave empty for Super Admin accounts.</small>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group-modern">
